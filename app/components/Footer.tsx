    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://asd.edu.ar/#cursos" className="hover:text-blue-400 transition-colors">
                  Cursos Academia
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:Info@asd.edu.ar" className="hover:text-blue-400 transition-colors">
                  Info@asd.edu.ar
                </a>
              </li>
              <li>
                <a href="tel:3514262066" className="hover:text-blue-400 transition-colors">
                  351 4262066
                </a>
              </li>
              <li className="text-sm">
                Ituzaingó 159, Córdoba Argentina
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  href="https://wa.me/5493514262066" 
                  target="_blank" 
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/academiadesoftware"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-400 transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/company/academiadesoftware"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-400 transition-colors"
              >
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Academia de Software. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
